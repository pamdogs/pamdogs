...
var __adobewebfontsappname__ = "muse";
 ...
 <body>
  ...
  <div class="clearfix borderbox" id="page"><!-- group -->
   <div class="SlideShowWidget clearfix HeroFillFrame grpelem" id="slideshowu281"><!-- none box -->
    &nbsp;
  ...
  <div class="preload_images">
   <img class="preload" src="images/u554-17-r.png" alt=""/>
   <img class="preload" src="images/u554-17-m.png" alt=""/>
  </div>
  <!-- JS includes -->
  <script type="text/javascript">
  ...
  <script type="text/javascript">
   $(document).ready(function() {
       try {
           (function() {
               ...
               (function() {
                   ...
                   c.remove();
                   if (Muse.assets.outOfDate.length || Muse.assets.required.length) c = "Puede que determinados archivos falten en el servidor o sean incorrectos. Limpie la cache del navegador e inténtelo de nuevo. Si el problema persiste, póngase en contacto con el administrador del sitio web.", (d = location && location.search && location.search.match && location.search.match(/muse_debug/gi)) && Muse.assets.outOfDate.length && (c += "\nOut of date: " + Muse.assets.outOfDate.join(",")), d && Muse.assets.required.length && (c += "\nMissing: " + Muse.assets.required.join(",")), alert(c)
               })()
           })();
           /* body */
           ...
           Muse.Utils.initWidget('#slideshowu281', ['#bp_infinity'], function(elem) {
      ...
      /*if($(window).width()<768){
        var ancho = $("#u632").width() / 2;
        var boton = $("#u554-17").width() / 2;
        var total = ancho - boton;
        $("#u554-17").css("left",total)
      }
